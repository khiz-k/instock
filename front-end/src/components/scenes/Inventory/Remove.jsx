    ...
    return (
      ...
      <div className="table-row__remove">
        <div className="table-row__remove--dropdown-handle">
          <input onClick={this.open} className="table-row__remove-button" alt="kebab" type="image" src={kebab} />
          <div className="table-row__remove--dropdown-content">
            {this.state.open ? (
              <div className="table-row__remove--dropdown-content__options" onClick={(event) => { delHandler(this.props.itemID) }} href="#"> <p>Remove</p></div>
            ) : (null)}
