...
class ItemDetails extends Component {
  ...
  render() {
    ...
    if (!item) {
      return "Cannot find the item you are looking for";
    }
    ...
    return (
      <div className="container item-details">
        <div className="item-details__header">
          <div
            className="item-details__title-wrapper"
          ...
          <button
            className={`item-details__stock-tag ${
              item.isInstock ? "item-details__stock-tag--in-stock" : ""
            }`}
          >
            {this.stockStatus()}
          </button>
