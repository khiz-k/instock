...
export default class AddWarehouseModal extends React.Component {
  ...
  post = () => {
    if (
      ...
      axios.post(
        "https://khiz-instock-backend.herokuapp.com/warehouses",
        newHouse
      );
  ...
  render() {
    ...
    return (
      <>
        <div
          onClick={() => this.props.changeMobile()}
          className="form-open mobile"
        >
        ...
        <div
          ...
          style={{
            display: `${
              this.props.mobile === true ? "flex" : this.state.active
            }`,
            position: `${position}`,
          }}
        >
          <div className="modal__content">
            ...
            <div className="modal__content-container">
              ...
              <div className="modal__content-container-input categories-container">
                <h4 className="modal__content-subheader categories-content">
                  Categories
                </h4>
                <input
              ...
              <div className="modal__content-btn-container">
                ...
                <h5
                  onClick={() => this.props.changeMobile()}
                  className="modal__content-cancel mobile"
                >
                  Cancel
                </h5>
                <h5
                  onClick={this.cancelBackToPage}
                  className="modal__content-cancel tablet"
                >
                  Cancel
                </h5>
              </div>
