...
app.get("/warehouses/:id", (req, res) => {
  ...
  if (checkStatus) {
    ...
    let warehouseInventoryItems = inventoryList.filter(
...
app.get("/warehouses/:id/contact", (req, res) => {
  ...
  let contactInfo = warehousesList.filter(
...
app.get("/warehouses/:id/address", (req, res) => {
  ...
  let addressInfo = warehousesList.filter(
...
app.delete("/inventory/:id", (req, res) => {
  ...
  if (checkStatus) {
    const itemIndex = inventoryList.findIndex(
